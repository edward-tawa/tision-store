...
urlpatterns = [
    ...
    path('store/', schema_view.with_ui('swagger',
         cache_timeout=0), name="swagger-ui"),
    path('store/api/schema/', schema_view.with_ui('swagger',
         cache_timeout=0), name="swagger-ui"),
    path('store/api/schema/redoc/',
         schema_view.with_ui('redoc', cache_timeout=0), name="redoc-ui"),
